...
namespace GW2EIParser.EIData
{
    public class Buff
    {
        ...
        private static readonly List<Buff> _elementalist = new List<Buff>
        {
                ...
                new Buff("Dual Fire Attunement", WeaverHelper.FireDual, BuffSource.Elementalist, BuffType.Duration, 1, BuffNature.GraphOnlyBuff, Logic.Override, "https://wiki.guildwars2.com/images/b/b4/Fire_Attunement.png"),
                new Buff("Fire Water Attunement", WeaverHelper.FireWater, BuffSource.Elementalist, BuffType.Duration, 1, BuffNature.GraphOnlyBuff, Logic.Override, "https://i.imgur.com/ihqKuUJ.png"),
                new Buff("Fire Air Attunement", WeaverHelper.FireAir, BuffSource.Elementalist, BuffType.Duration, 1, BuffNature.GraphOnlyBuff, Logic.Override, "https://i.imgur.com/kKFJ8cT.png"),
                new Buff("Fire Earth Attunement", WeaverHelper.FireEarth, BuffSource.Elementalist, BuffType.Duration, 1, BuffNature.GraphOnlyBuff, Logic.Override, "https://i.imgur.com/T4187h0.png"),
                // Water
                ...
                new Buff("Dual Water Attunement", WeaverHelper.WaterDual, BuffSource.Elementalist, BuffType.Duration, 1, BuffNature.GraphOnlyBuff, Logic.Override, "https://wiki.guildwars2.com/images/3/31/Water_Attunement.png"),
                new Buff("Water Fire Attunement", WeaverHelper.WaterFire, BuffSource.Elementalist, BuffType.Duration, 1, BuffNature.GraphOnlyBuff, Logic.Override, "https://i.imgur.com/vMUkzxH.png"),
                new Buff("Water Air Attunement", WeaverHelper.WaterAir, BuffSource.Elementalist, BuffType.Duration, 1, BuffNature.GraphOnlyBuff, Logic.Override, "https://i.imgur.com/5G5OFud.png"),
                new Buff("Water Earth Attunement", WeaverHelper.WaterEarth, BuffSource.Elementalist, BuffType.Duration, 1, BuffNature.GraphOnlyBuff, Logic.Override, "https://i.imgur.com/QKEtF2P.png"),
                // Air
                ...
                new Buff("Dual Air Attunement", WeaverHelper.AirDual, BuffSource.Elementalist, BuffType.Duration, 1, BuffNature.GraphOnlyBuff, Logic.Override, "https://wiki.guildwars2.com/images/9/91/Air_Attunement.png"),
                new Buff("Air Fire Attunement", WeaverHelper.AirFire, BuffSource.Elementalist, BuffType.Duration, 1, BuffNature.GraphOnlyBuff, Logic.Override, "https://i.imgur.com/vf68GJm.png"),
                new Buff("Air Water Attunement", WeaverHelper.AirWater, BuffSource.Elementalist, BuffType.Duration, 1, BuffNature.GraphOnlyBuff, Logic.Override, "https://i.imgur.com/Tuj5Sro.png"),
                new Buff("Air Earth Attunement", WeaverHelper.AirEarth, BuffSource.Elementalist, BuffType.Duration, 1, BuffNature.GraphOnlyBuff, Logic.Override, "https://i.imgur.com/lHcOSwk.png"),
                // Earth
                ...
                new Buff("Dual Earth Attunement", WeaverHelper.EarthDual, BuffSource.Elementalist, BuffType.Duration, 1, BuffNature.GraphOnlyBuff, Logic.Override, "https://wiki.guildwars2.com/images/a/a8/Earth_Attunement.png"),
                new Buff("Earth Fire Attunement", WeaverHelper.EarthFire, BuffSource.Elementalist, BuffType.Duration, 1, BuffNature.GraphOnlyBuff, Logic.Override, "https://i.imgur.com/aJWvE0I.png"),
                new Buff("Earth Water Attunement", WeaverHelper.EarthWater, BuffSource.Elementalist, BuffType.Duration, 1, BuffNature.GraphOnlyBuff, Logic.Override, "https://i.imgur.com/jtjj2TG.png"),
                new Buff("Earth Air Attunement", WeaverHelper.EarthAir, BuffSource.Elementalist, BuffType.Duration, 1, BuffNature.GraphOnlyBuff, Logic.Override, "https://i.imgur.com/4Eti7Pb.png"),
                //forms

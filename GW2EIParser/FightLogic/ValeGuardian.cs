        ...
        public override void ComputeNPCCombatReplayActors(NPC npc, ParsedLog log, CombatReplay replay)
        {
            ...
            switch (npc.ID)
            {
                ...
                case (ushort)BlueGuardian:
                    replay.Decorations.Add(new CircleDecoration(false, 0, 1500, lifespan, "rgba(0, 0, 255, 0.5)", new AgentConnector(npc)));
                    break;
                case (ushort)GreenGuardian:
                    replay.Decorations.Add(new CircleDecoration(false, 0, 1500, lifespan, "rgba(0, 255, 0, 0.5)", new AgentConnector(npc)));
                    break;
                case (ushort)RedGuardian:
                    replay.Decorations.Add(new CircleDecoration(false, 0, 1500, lifespan, "rgba(255, 0, 0, 0.5)", new AgentConnector(npc)));
                    break;
                case (ushort)Seekers:
                    replay.Decorations.Add(new CircleDecoration(false, 0, 180, lifespan, "rgba(255, 0, 0, 0.5)", new AgentConnector(npc)));
                    break;
                default:
                    break;
            }
